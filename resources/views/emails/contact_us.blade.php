...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <p>Dear Admin,</p>
            <p>
                One Student Registered for course please check details bellow.
            </p>
             <strong> Details:</strong><br><br>

              Date: {{ $detail->created_at->format('d/m/Y') }} <br>
           
            <p><strong>{{ $detail?->first_name  }} {{ $detail?->last_name  }}</strong>! 🎉  Email: {{ $detail?->email  }}</p>

            <p>Mobile Number : {{ $detail?->mobile  }}</p>
            ...
            <p>Hear About : {{ $detail?->hear_about  }}</p>
            
           
            
            <p>Branch : {{ $detail?->branch_id  }}</p>
